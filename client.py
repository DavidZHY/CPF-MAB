...
class client(object):
    def __init__(self,
        ...
        self.local_mean = local_mean # local mean of each arm
        self.global_mean = global_mean # global mean of each arm
        self.mixed_mean = mixed_mean # mixed mean of each arm (alpha*local_mean+(1-alpha)*global_mean)
